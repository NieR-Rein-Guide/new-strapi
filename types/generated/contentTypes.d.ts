...
export interface ApiFaqFaq extends Schema.SingleType {
  ...
  attributes: {
    qa: Attribute.Component<'qa.q-a', true> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiLoreLore extends Schema.CollectionType {
  ...
  attributes: {
    type: Attribute.Enumeration<['quest', 'event', 'dark']> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    released_date: Attribute.Date &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    character_id: Attribute.Integer &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    slug: Attribute.UID<'api::lore.lore', 'title'> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
